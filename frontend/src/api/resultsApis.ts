...
const api = {
  async getScriptResponses(scriptId: string): Promise<Session[]> {
    const response = await authAxios.get(`/api/script/${scriptId}/responses`)
  ...
  async getScriptCommentInsights(
    ...
    const response = await authAxios.get(`/api/script/${scriptId}/commentInsights`)
    return response.data
  },
  ...
  async getScriptQuestionInsights(
    ...
    const response = await authAxios.get(`/api/script/${scriptId}/questionInsights`, {
      params: { filter }
    })
    return response.data
  },
  ...
  async getScriptQuestionInsightUsers(
    ...
    const response = await authAxios.get(
      `/api/script/${scriptId}/questionInsights/users`,
      {
  ...
  async getResponseStats(scriptId: string): Promise<ResponseStatistics> {
    const response = await authAxios.get(`/api/script/${scriptId}/responseStats`)
    return response.data
  }
}
